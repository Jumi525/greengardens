...
const Header = () => {
  ...
  return (
    <section className="bg-green-900 py-2 items-center flex justify-between px-4">
...
80 199 0 90 -31 170 -106 277 -24 34 -44 64 -44 68 0 9 34 -2 97 -30z"
        ...
        <p className="text-[#737373] font-[900] text-2xl">GG</p>
      </Link>
      <Navbar isOpen={isOpen} setIsOpen={setIsOpen} />
      <div className="flex items-center gap-2 ">
        <Link
          href={"/signup"}
          className="bg-[#737373] px-3 py-1 rounded-lg hidden sm:block"
        >
          SignUp
        </Link>
        <Link href={"/login"} className="bg-[#737373] px-3 py-1 rounded-lg">
          Login
        </Link>
        <div
          onClick={() => setIsOpen((prev) => !prev)}
          className=" border-2 border-solid border-transparent hover:border-[#737373] m-2
        text-2xl p-1 cursor-pointer rounded-xl md:hidden text-[#737373]
        "
        >
          <TiThMenuOutline />
        </div>
