    ...
    <main>
      <section className=" grid sm:grid-cols-2 px-4 items-center py-7">
        <div className="flex flex-col gap-3 sm:gap-4 max-w-[330px] md:max-w-[400px] mx-auto pb-4 sm:pb-0">
          ...
          <button className="bg-green-700 px-4 py-2 max-w-max rounded-full">
            Shop Now
          </button>
        </div>
      ...
      <section className="text-white grid sm:grid-cols-3 bg-green-700 px-4">
      ...
      <section className="py-7 px-4">
        ...
        <div className=" flex flex-wrap gap-4 justify-center">
          <div className="bg-green-300 flex items-center w-48 gap-2 px-2 py-2 text-white">
            <Image src={fresh} alt="fresh" />
            <span>Fresh Vegetables</span>
          </div>

          <div className="bg-green-300 flex items-center gap-2 w-48 px-2 py-2 text-green-400">
          ...
          <div className="bg-green-300 flex items-center gap-2 w-48 px-2 py-2 text-white">
      ...
      <section className="my-7  px-4 relative bg-green-500/40">
        ...
        <section className="absolute top-0 bottom-0 left-0 right-0 m-auto  grid place-content-center">
          <div className="flex flex-col gap-3 sm:gap-4 max-w-[400px] md:max-w-[450px] mx-auto pb-4 sm:pb-0">
            ...
            <p className="text-black/70 mx-auto">
              It has survived not only five centuries also there leaped.
            </p>
            <button className="bg-green-700 mx-auto px-4 py-2 max-w-max rounded-full">
              Shop Now
            </button>
          </div>
        </section>
      ...
      <section className="px-4 py-7 w-full">
        <p className="text-green-400 mx-auto max-w-max ">Summer Offer</p>
        ...
        <div className="verticalsscroll mt-7 flex justify-around max-w-[1024px] mx-auto gap-3">
          <div className="verticalschild flex-shrink-0 bg-green-200 max-w-[215px] px-2 py-4 flex flex-col gap-4 rounded-lg">
            ...
            <p className="text-black/60 text-center text-sm">
              This website is a tresure, you can easily get fresh produce from
              here
            </p>
            <p className="font-bold mx-auto">Nicolas Thompson</p>
          </div>
          <div className="verticalschild flex-shrink-0 bg-green-200 max-w-[215px] px-2 py-4 flex flex-col gap-4 rounded-lg">
            <div className="flex items-center gap-5 justify-center">
              <Image src={Lquote} alt="lQ" />
